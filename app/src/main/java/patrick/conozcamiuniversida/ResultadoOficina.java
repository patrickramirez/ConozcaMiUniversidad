...
public class ResultadoOficina extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_oficina);
            ...
            try {
                ...
                if (EdificioArea != null) {
                    if (null != gm) {
                        ...
                        txtestadoArea.setText(_mysqlDAO.getEstadoEdificioMysql(EdificioArea));
    ...
    public void btnEstoyAqui(View v) {
        startActivity(new Intent(this, ResultadoMapaOficina.class));
        finish();
    }
